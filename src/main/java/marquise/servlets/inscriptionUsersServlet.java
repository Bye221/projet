...
@WebServlet("/inscriptionUsers")
public class inscriptionUsersServlet extends AbstractGenericServlet{

	/**
	 * 
	 */
	private static final long serialVersionUID = 6727827753539591443L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		templateEngine.process("connectedUsers/inscriptionUsers", context, resp.getWriter());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			resp.sendRedirect("inscriptionUsers");
		} 
